  ...
  return (
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll">
        {/* ✅ FIXED: Removed Age column - changed to 6 columns */}
          ...
          appointments.map((item, index) => (
            ...
            >
              ...
              {item.status === 'cancelled' ? (
                <p className="text-red-500 text-sm font-semibold bg-red-50 px-3 py-1 rounded-full text-center">
                  Cancelled
                </p>
              ) : item.status === 'completed' ? (
                <p className="text-green-600 text-sm font-semibold bg-green-50 px-3 py-1 rounded-full text-center">
                  Completed
                </p>
              ) : item.status === 'pending' ? (
